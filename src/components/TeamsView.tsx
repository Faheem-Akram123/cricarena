            ...
            {modalType === 'new' && (
              <div className="space-y-4">
                ...
                <div className="form-group">
                  ...
                  <input type="file" onChange={handleLogoUpload} accept="image/*" className="w-full px-3.5 py-2 border border-slate-200 rounded-xl text-xs bg-white focus:outline-emerald-505" />
                </div>
            ...
            {modalType === 'edit' && selectedTeam && (
              <div className="space-y-4">
                ...
                <div className="form-group">
                  ...
                  <input type="file" onChange={handleLogoUpload} accept="image/*" className="w-full px-3.5 py-2 border border-slate-200 rounded-xl text-xs bg-white" />
                </div>
